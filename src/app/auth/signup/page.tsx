        ...
        <Card className="border-0 shadow-lg">
          ...
          <CardContent className="space-y-6">
            ...
            <div className="space-y-3">
              ...
              >
                <Link href="/api/auth/signin/kakao">
                  <svg className="w-5 h-5 mr-2" viewBox="0 0 24 24">
                    <path
                      fill="#000"
                      d="M12 3c5.799 0 10.5 3.664 10.5 8.185 0 4.52-4.701 8.184-10.5 8.184a13.5 13.5 0 0 1-1.727-.11L5.526 21.75c-.5.5-1.365.148-1.365-.564V16.24C2.113 14.311 1.5 12.114 1.5 9.185 1.5 4.665 6.201 3 12 3z"
                    />
                  </svg>
                  카카오로 가입하기
                </Link>
